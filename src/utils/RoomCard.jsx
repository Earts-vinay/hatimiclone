...
const RoomCard = ({ image, title, location, capacity, rating, rooms, size, amenities, PropertyLocation, price, taxes, availableRooms,is_booked }) => {
  ...
  return (
    <Grid item xs={12} sm={12} md={12} lg={12}>
      <Box sx={{ boxShadow: 4, backgroundColor: "#1E2526", borderRadius: 2, }}>
        ...
        >
         <Box sx={{ position: 'relative', width: { lg: "350px", md: "100%", sm: "100%", xs: "100%" }, height: { lg: "280px", md: "300px", sm: "300px", xs: "200px" } }}>
  <Box
    component="img"
    src={image}
    alt={title}
